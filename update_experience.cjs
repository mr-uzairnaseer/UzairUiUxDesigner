...
// 1. Add Briefcase to imports
appJsx = appJsx.replace(/GraduationCap, X,/, 'GraduationCap, X, Briefcase,');

// 2. Add ap-edu-cards CSS
appJsx = appJsx.replace(/(\.ap-edu-card \{)/, '.ap-edu-cards { display: flex; flex-direction: column; gap: 24px; width: 100%; }\n  $1');

// 3. Replace the single card HTML
const oldCard = \`<div className="ap-edu-card sr-group">
...
const newCards = \`<div className="ap-edu-cards sr-group">
